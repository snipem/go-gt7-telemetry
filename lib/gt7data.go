...
func NewGTData(ddata []byte) GTData {
	...
	data.PositionX = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x04 : 0x04+4]))
	data.PositionY = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x08 : 0x08+4]))
	data.PositionZ = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x0C : 0x0C+4]))
	data.VelocityX = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x10 : 0x10+4]))
	data.VelocityY = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x14 : 0x14+4]))
	data.VelocityZ = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x18 : 0x18+4]))
	data.RotationPitch = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x1C : 0x1C+4]))
	data.RotationYaw = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x20 : 0x20+4]))
	data.RotationRoll = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x24 : 0x24+4]))
	data.AngularVelocityX = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x2C : 0x2C+4]))
	data.AngularVelocityY = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x30 : 0x30+4]))
	data.AngularVelocityZ = math.Float32frombits(binary.LittleEndian.Uint32(ddata[0x34 : 0x34+4]))
